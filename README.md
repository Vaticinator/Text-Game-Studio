...
A complete toolkit for creating, editing, and playing text-based adventure games, interactive fiction, and RPGs.

This project consists of two decoupled components:

- The Visual Editor: A web-based node graph editor that allows you to write branching narratives and export them as a standardized JSON file.
